                ...
                <div class="flex flex-row gap-x-16">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $donatur->created_at->format('d F Y') }}
                            </h3>
                        </div>
                        <div class="">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm">Target
                            {{ 'Rp ' . number_format($donatur->fundraising->target_amount, 0, ',', '.') }}</p>
                    </div>
                </div>
                <hr class="my-5">
