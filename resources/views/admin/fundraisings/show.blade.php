        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @if ($fundraising->is_active)
                    <span class="text-white font-bold bg-green-500 rounded-2xl w-fit p-5"> Fundraising telah aktif dan
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <form action="{{ route('admin.fundraisings.destroy', $fundraising) }}" method="POST">
                            ...
                            <button type="submit" class="font-bold py-4 px-6 bg-red-700 text-white rounded-full"
                                onclick="return confirm('Are you sure you want to delete this fundraising?')">
                                Delete
                            </button>
                        </form>
                    </div>
                ...
                @forelse ($fundraising->donaturs as $donatur)
                    <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                        <div class="flex flex-row items-center gap-x-3">
                            <div class="flex flex-col">
                                <h3 class="text-indigo-950 text-xl font-bold">
                                    {{ 'Rp ' . number_format($donatur->total_amount, 0, ',', '.') }}</h3>
