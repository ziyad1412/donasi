            ...
            <nav class="pt-5 px-3 flex justify-between items-center">
                <div class="flex items-center gap-[10px]">
                    ...
                    <div class="flex flex-col text-white">
                        ...
                        <p class="font-semibold text-sm">Depok, Indonesia</p>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col gap-[14px] rounded-2xl border border-[#E8E9EE] p-[14px] w-[208px]">
                            ...
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="text-xs leading-[18px]">Target <span class="font-bold text-[#FF7815]">
                                        {{ 'Rp ' . number_format($fundraising->target_amount, 0, ',', '.') }}</span></p>
                            </div>
                        ...
                        <div class="w-full border border-[#E8E9EE] flex items-center p-[14px] gap-3 rounded-2xl bg-white">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <p class="text-xs leading-[18px]">Target <span
                                        class="font-bold text-[#FF7815]">{{ 'Rp ' . number_format($fundraising->target_amount, 0, ',', '.') }}</span>
                                </p>
