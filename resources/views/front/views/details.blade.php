            ...
            <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-sm text-[#66697A]">
                            {{ 'Rp ' . number_format($fundraising->totalReachedAmount(), 0, ',', '.') }}</p>
                        <p class="font-bold text-[20px] leading-[30px] text-[#76AE43]">
                            {{ 'Rp ' . number_format($fundraising->target_amount, 0, ',', '.') }}</p>
                    </div>
                ...
                <div class="flex flex-col gap-[2px]">
                    ...
                    @if (strlen($fundraising->about) > 100)
                        <p class="desc-less text-sm leading-[26px]">{{ substr($fundraising->about, 0, 100) }}<button
                                class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()"> See more</button></p>
                        <p class="desc-more text-sm leading-[26px] hidden">{{ $fundraising->about }}<button
                        ...
                        @forelse ($fundraising->donaturs as $donatur)
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col gap-[2px] w-full">
                                    <div class="flex items-center justify-between">
                                        <p class="font-bold">
                                            {{ 'Rp ' . number_format($donatur->total_amount, 0, ',', '.') }}</p>
